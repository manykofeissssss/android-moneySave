...
import com.example.billkeeper.ui.shared.IncomeRow
...
import com.example.billkeeper.ui.theme.INCOME_COLORS
...
fun AddIncomeTab(
    ...
    LazyColumn(
        ...
        item {
            Text("本月收入  (${incomes.size})", fontWeight = FontWeight.Bold, fontSize = 18.sp, modifier = Modifier.padding(top = 4.dp))
        }
